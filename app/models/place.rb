class Place < ActiveRecord::Base
  self.data = [ 
    ...
    {id: 13, prefecture: '千葉県', area: ''},{id: 14, prefecture: '東京都', area: '渋谷•原宿周辺'}, {id: 15, prefecture: '東京都', area: '下北沢周辺'}, 
    ...
    {id: 25, prefecture: '東京都', area: 'その他23区内'}, {id: 26, prefecture: '東京都', area: 'その他都下'}, {id: 27, prefecture: '神奈川県', area: '横浜•川崎'},
    ...
    {id: 40, prefecture: '滋賀県', area: ''}, {id: 41, prefecture: '京都府', area: ''}, {id: 42, prefecture: '大阪府', area: '心斎橋•難波'},
    {id: 43, prefecture: '大阪府', area: '梅田'},{id: 44, prefecture: '大阪府', area: 'その他'},{id: 45, prefecture: '兵庫県', area: ''}, 
    {id: 46, prefecture: '奈良県', area: ''}, {id: 47, prefecture: '和歌山県', area: ''},{id: 48, prefecture: '鳥取県', area: ''}, 
    {id: 32, prefecture: '島根県', area: ''}, {id: 33, prefecture: '岡山県', area: ''},{id: 34, prefecture: '広島県', area: ''}, 
    {id: 49, prefecture: '山口県', area: ''}, {id: 50, prefecture: '徳島県', area: ''},{id: 51, prefecture: '香川県', area: ''},
    {id: 52, prefecture: '愛媛県', area: ''}, {id: 53, prefecture: '高知県', area: ''},{id: 54, prefecture: '福岡県', area: ''}, 
    {id: 55, prefecture: '佐賀県', area: ''}, {id: 56, prefecture: '長崎県', area: ''},{id: 57, prefecture: '熊本県', area: ''}, 
    {id: 58, prefecture: '大分県', area: ''}, {id: 59, prefecture: '宮崎県', area: ''},{id: 60, prefecture: '鹿児島県', area: ''}, 
    {id: 61, prefecture: '沖縄県', area: ''}
  ]
end